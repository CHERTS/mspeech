...
uses
  ...
  Dialogs, GlobalGTTS, SHFolder, MGGoogleTTS, TntStdCtrls, StdCtrls;
...
begin
  GoogleTL := MGGoogleTTS1.GTTSLanguageNameToCode((Sender as TTntComboBox).Items[(Sender as TTntComboBox).ItemIndex]);
